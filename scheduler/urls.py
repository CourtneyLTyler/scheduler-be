...
urlpatterns = [
    ...
    path('schedulebyshifts', views.ScheduleByShiftList.as_view(),
         name='schedule-by-shift-list'),
    path('schedulebyshift/<int:pk>', views.ScheduleByShiftDetail.as_view(),
         name='schedule-by-shift-detail'),

    path('unavailability', views.UnavailabilityList.as_view(),
         name='unavailability-list'),
    path('unavailability/<int:pk>', views.UnavailabilityDetail.as_view(),
         name='unavailability-detail'),

    path('weeklyavailability', views.WeeklyAvailabilityList.as_view(),
         name='weeklyavailability-list'),
    path('weeklyavailability/<int:pk>', views.WeeklyAvailabilityDetail.as_view(),
         name='weeklyavailability-detail'),
]
